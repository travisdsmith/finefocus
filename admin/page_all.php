...
?>
<h1 class="page-header"><i class="fa fa-files-o fa-fw"></i>&nbsp;Pages&nbsp;<a class="btn btn-default" href="page_edit.php" role="button" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-plus fa-fw"></i></a></h1>
...
$pages = Page::find_by_sql("SELECT * FROM " . Page::get_table_name() . " LIMIT {$per_page} OFFSET {$pagination->offset()}");
...
if ($pages) {
    ...
    if ($pagination->total_pages() > 1) {
        ...
        if ($pagination->has_previous_page()) {
            echo "<li><a href=\"page_all.php?page=1\" aria-label=\"First Page\"><span aria-hidden=\"true\">&laquo;</span></a></li>";
            echo "<li><a href=\"page_all.php?page={$pagination->previous_page()}\" aria-label=\"Previous\"><span aria-hidden=\"true\">&lsaquo;</span></a></li>";
        }
        ...
        if ($pagination->total_pages() > 5) {
            if ($page <= 2) {
                for ($i = 1; $i <= 5; $i++) {
                    if ($i == $page) {
                        echo "<li class=\"active\"><a href=\"page_all.php?page={$i}\"> {$i} <span class=\"sr-only\">(current)</span></a></li>";
                    } else {
                        echo "<li><a href=\"page_all.php?page={$i}\"> {$i} </a></li>";
                    }
                }
        ...
        if ($pagination->has_next_page()) {
            echo "<li><a href=\"page_all.php?page={$pagination->next_page()}\" aria-label=\"Next\"><span aria-hidden=\"true\">&rsaquo;</span></a></li>";
            echo "<li><a href=\"page_all.php?page={$pagination->total_pages()}\" aria-label=\"Last Page\"><span aria-hidden=\"true\">&raquo;</span></a></li>";
        }
        echo "</ul></nav>" . PHP_EOL;
    }
} else {
